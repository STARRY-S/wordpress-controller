...
import (
	...
	"github.com/STARRY-S/wordpress-controller/pkg/generated/clientset/versioned/scheme"
...
// ControllerV1Client is used to interact with features provided by the controller.hxstarrys.me group.
type ControllerV1Client struct {
	restClient rest.Interface
}

func (c *ControllerV1Client) Wordpresses(namespace string) WordpressInterface {
